...
describe('Service Tests', () => {
  describe('Travel Service', () => {
    ...
    let expectedResult: ITravel | ITravel[] | boolean | null;
    ...
    beforeEach(() => {
      ...
      elemDefault = new Travel(0, 'AAAAAAA');
    });
    ...
    describe('Service methods', () => {
      ...
      it('should create a Travel', () => {
        ...
        service.create(new Travel()).subscribe(resp => (expectedResult = resp.body));
      ...
      it('should return a list of Travel', () => {
        const returnedFromService = Object.assign(
          {
            name: 'BBBBBB',
          },
